...
class TestProjectLifecycle(unittest.TestCase):
    ...
    def test_project_manifest_structure(self):
        ...
        manifest = {
            ...
            "counts": {"initialImages": 0, "finalImages": 0},
            "steps": [
        ...
        created_at = datetime.fromisoformat(
            manifest["createdAt"].replace("Z", "+00:00")
        )
    ...
    def test_project_directory_structure(self):
        ...
        expected_dirs = [project_root, project_root / "selected", project_root / "crop"]
    ...
    def test_project_steps_initialization(self):
        ...
        for step in steps:
            ...
            self.assertIn(
                step["name"], ["selection", "sorting", "cropping", "delivery"]
            )
