...
class TestFileSafetyAudit(unittest.TestCase):
    ...
    def test_no_dangerous_file_modifications(self):
        ...
        if dangerous_issues:
            ...
            self.fail(
                f"Found {len(dangerous_issues)} files with potentially dangerous file modifications"
            )
