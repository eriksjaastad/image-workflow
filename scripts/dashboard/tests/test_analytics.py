...
class TestAlignment:
    ...
    def test_align_single_record(self):
        ...
        records = [
            {"time_slice": "2025-10-02", "script": "test_tool", "file_count": 100}
        ]
...
class TestEdgeCases:
    ...
    def test_sparse_data(self):
        ...
        records = [{"time_slice": "2025-10-15", "script": "rare_tool", "file_count": 5}]
...
def test_toy_example_hourly():
    ...
    baseline = ["2025-10-15T14:00:00", "2025-10-15T15:00:00", "2025-10-15T16:00:00"]
