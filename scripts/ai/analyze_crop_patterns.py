...
def analyze_crop_data() -> None:
    ...
    # Interpretation
    if (width_variance < 0.15 and height_variance < 0.15) or (
        width_variance < 0.25 and height_variance < 0.25
    ):
        pass
    else:
        pass

    if (x_variance < 0.1 and y_variance < 0.1) or (
        x_variance < 0.15 and y_variance < 0.15
    ):
        pass
    else:
        pass
