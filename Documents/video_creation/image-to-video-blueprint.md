...
- All file operations must be logged via `FileTracker` per [FILE_SAFETY_SYSTEM](../safety/FILE_SAFETY_SYSTEM.md).
...
*See also: [ARCHITECTURE_OVERVIEW](../core/ARCHITECTURE_OVERVIEW.md), [DASHBOARD_GUIDE](../dashboard/DASHBOARD_GUIDE.md), [PROJECT_STRUCTURE_STANDARDS](../../../project-scaffolding/Documents/PROJECT_STRUCTURE_STANDARDS.md), and [Doppler Secrets Management](Documents/reference/DOPPLER_SECRETS_MANAGEMENT.md).*
